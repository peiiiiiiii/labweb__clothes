...
async function outcheck(count){
    ...
    if(count === 1){
        Array.from(ccheck).forEach((element, i) => {
            let subtotal = element.qty * element.itemPrice;
            // console.log(element);
                ...
                <div class="table__row">
                        ...
                        <div class="product">
                            ...
                            <div class="product__des">
                                <p class="product__title">
                                    <a href="detail.html?id=${element.id}"><span class="product__ja"></span><span class="product__en">${element.title}</span>
                                    </a>
                                </p>
                    ...
                    <div class="table__cell table__cell--quantity">
                        ...
                        <div class="form__select">
                            <div class="quantity__border"  data-id=${element.id} data-color= ${element.color} data-size= ${element.size}>
                                <span class="quantity__Button Link Link--secondary  form__select-btn js-detail-mins">
                                    <svg class="Icon Icon--minus" role="presentation" viewBox="0 0 16 2">
                                        <path d="M1,1 L15,1" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="square"></path>
                                    </svg>
                                </span>
                                <input type="text" class="quantity__current" id="add__input" pattern="[0-9]*" value=${element.qty}>
                    ...
                    <div class="table__cell table__cell--remove">
                        <p class="remove productTag-item" data-id=${element.id} data-color= ${element.color} data-size= ${element.size}>
                            <span>刪除</span>
                        </p>
                    </div>
                </div>
...
async function aftercheckout(){
    ...
    let totalllllll =  document.querySelector('#total__yen');
    let TOTAL = 0;
    ...
    // console.log(separator(total__c))
        totalllllll.innerHTML = convert(totallll);
    }
    // del
...
async function payment(){
    const tt = document.querySelector(".vvv");
