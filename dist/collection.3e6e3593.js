...
},{"./main.js":"epB2"}],"nh2y":[function(require,module,exports) {
"use strict";
...
exports.colectionsearch = colectionsearch;
exports.profiletoken = profiletoken;
...
function _makeRequest() {
  _makeRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(method, url, data) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              ...
              xhr.onload = function () {
                if (this.status >= 200 && this.status < 300) {
                  if (xhr.response != "") resolve(JSON.parse(xhr.response));else resolve("");
                } else {
                  reject({
                    status: this.status,
                    statusText: xhr.statusText
...
function _Delete() {
  _Delete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(CommodityId) {
    var result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return makeRequest("GET", "/Commodity/Delete/" + CommodityId, null);
...
function colectionsearch(_x5) {
  return _colectionsearch.apply(this, arguments);
}

function _colectionsearch() {
  _colectionsearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
    var result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return makeRequest("POST", "/Commodity/Search", JSON.stringify(params));
...
function profiletoken() {
  return _profiletoken.apply(this, arguments);
}

function _profiletoken() {
  _profiletoken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var result;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return makeRequest("GET", "/Commodity/GetTopCommodity");
...
function _GetColor() {
  _GetColor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return makeRequest("GET", "/Color/GetAll", null);
...
function _GetAllTags() {
  _GetAllTags = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var result;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return makeRequest("GET", "/Tags/GetAll", null);
...
var _fornt__api = require("./fornt__api.js");
...
var token = localStorage.getItem('token');
var search__item = '';
var search__area = ''; // get url

var queryString = window.location.search;
var urlParams = new URLSearchParams(queryString);
var kindID = urlParams.get('kind');
console.log(kindID);
var kind = '';
var navbtn = document.querySelector(".js-header-nav");
var header_navArea = document.querySelector(".js-header-navArea");
...
var bgheader = document.querySelector(".js-header-bg");
var search__inner = document.querySelector(".js-header-searchArea");
var collection__list = document.getElementById("collection__list"); // let filter__all = document.querySelector("#filter__cc");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var search_status = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var params, res, res__arr;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return (0, _fornt__api.colectionsearch)(params[0]);
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return (0, _fornt__api.profiletoken)();
  ...
  var getColor = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return (0, _fornt__api.GetAllTags)();
...
var wraperrrr = document.querySelector(".wraperrrr");

function showCollection(_x) {
  return _showCollection.apply(this, arguments);
}

function _showCollection() {
  _showCollection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(res) {
    var filterUrl;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            if (kindID) {
              filterUrl = res.filter(function (element) {
                var output = element.CommodityKinds.some(function (c) {
...
function toggle_s() {
  return _toggle_s.apply(this, arguments);
}

function _toggle_s() {
  _toggle_s = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
...
function showAllTag(_x2) {
  return _showAllTag.apply(this, arguments);
}

function _showAllTag() {
  _showAllTag = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(res) {
    var con;
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return res.forEach(function (element) {
              element.Tag.forEach(function (item, i) {
                if (item.Tag === "新品") {
                  con = "".concat(element.Kinds, " - ").concat(item.Tag);
                } else {
                  con = "".concat(item.Tag);
                }

                tag__content += "\n                    <li>\n                        <input type=\"radio\" id=\"category_".concat(item.TagsID, "\" name=\"kinds\" data-kind=\"").concat(element.Kinds, "\" value=\"").concat(item.Tag, "\">\n                        <label class=\"js-toggleInview-item\" for=\"category_").concat(item.TagsID, "\"  >").concat(con, "</label>\n                    </li>\n                    ");
              });
            });
...
function showColor(_x3) {
  return _showColor.apply(this, arguments);
}

function _showColor() {
  _showColor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(res) {
    var color__con;
...
function showlist(_x4) {
  return _showlist.apply(this, arguments);
}

function _showlist() {
  _showlist = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(res) {
    var filter__title;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            output = "";
            collection__list.innerHTML = ""; // console.log(res);
            ...
            if (res) {
              res.forEach(function (element) {
                ...
                output += "\n            <div class=\"item__list-item\" >\n                <a href=\"detail.html?id=".concat(element.CommodityId, "\" data-id=\"").concat(element.CommodityId, "\">\n                    <figure>\n                        <div class=\"item__list-photo js-follower-Area\">\n                            <img src=").concat(element.CommodityImages[0], ">\n                            \n                        </div>\n                        <figcaption>\n                        \n                        <p class=\"item__list-name\">").concat(element.CommodityName, "</p>\n                        <ul class=\"item__list-prices price-group\">\n                                <li class=\"item__list-price\">\n                                    <del class=\"price-delete\">\n                                        <span class=\"price-amount\">NT$ ").concat(element.Price, "</span>\n                                    </del>\n                                    <ins class=\"price-insert\">\n                                        <span class=\"price-amount\">NT$ ").concat(element.S_Price, "</span>\n                                    </ins>\n                                </li>\n                        </ul>\n                        </figcaption>\n                    </figure>\n                </a>\n            </div>\n            ");
              });
            } else {
            ...
            filter__title = document.querySelector(".filter__title");
            filter__title.innerHTML = "\u7537\u88DD - ".concat(kind);
            toggle_s();
            filter__sub();
            price__filter();
...
function filter__sub() {
  return _filter__sub.apply(this, arguments);
}

function _filter__sub() {
  _filter__sub = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.next = 2;
            return fliter__btn.addEventListener("click", function () {
              var kinds = document.getElementsByName('kinds');
              var colorss = document.getElementsByName('colorss');
              kind = '';
              var coloo = '';
              var tagsss = ''; // CommodityKinds
              ...
              var _iterator2 = _createForOfIteratorHelper(colorss),
                  _step2;
              ...
              function byTags(wantedkinds) {
                if (kind === "新品") {
                  return function (element) {
                    var output = element.CommodityTags.some(function (c) {
                      return c === wantedkinds && element.CommodityKinds.some(function (k) {
                        return k === tagsss;
                      });
                    });
                    return output;
                  ...
                  return function (element) {
                    var output = element.CommodityTags.some(function (c) {
                      return c === wantedkinds && element.CommodityKinds.some(function (c) {
                        return c === tagsss;
                      });
                    });
                    return output;
              ...
              function byColors(wantedColors) {
                return function (element) {
                  var output = element.CommodityColors.some(function (c) {
              ...
              var resultFilter = function resultFilter() {
                if (coloo !== "" && kind === "") {
              ...
              showlist(resultFilter()); // console.log(fimal)
              // showlist(fimal);
            });

          case 2:
            clear__btn.addEventListener("click", function () {
              var kinds = document.getElementsByName('kinds');
              var colorss = document.getElementsByName('colorss');
              ...
              for (var _i = 0; _i < colorss.length; _i++) {
                colorss[_i].checked = false;
              }
            });
...
function price__filter() {
  return _price__filter.apply(this, arguments);
}

function _price__filter() {
  _price__filter = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            Array.from(price__h).forEach(function (element, i) {
...
},{"./shoppingCart.js":"QiuZ","./fornt__api.js":"nh2y"}]},{},["tOYr"], null)
//# sourceMappingURL=/collection.3e6e3593.js.map