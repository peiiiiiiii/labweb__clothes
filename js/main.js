...
let wishlistBtn = document.querySelector(".js-wishlist-btn");
...
import {showCart,showWishlist} from "./shoppingCart.js";
...
document.addEventListener("DOMContentLoaded",  ()=> {
    ...
    navbtn.addEventListener('click', function(e) {
        ...
        if(header__side.classList.contains('is-open') || search__inner.classList.contains('is-open') || wish__side.classList.contains('is-open')){
            setTimeout(function(){
                header__side.style.display = "none";
                search__inner.style.display = "none";
                wish__side.style.display = "none";
...
function wishList(){
    ...
    if (navbtn.classList.contains('is-active')) {
        dis2(wish__side);
        // wish__side.style.display = "block";
        dis2(bgheader);
    } else {
